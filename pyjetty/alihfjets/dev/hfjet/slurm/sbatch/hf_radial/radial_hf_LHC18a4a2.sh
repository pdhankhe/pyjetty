...
OUTPUT_PREFIX="AnalysisResults/preeti/radial/$JOB_ID"
...
python process/user/hf_radial/process_mc_hfjet_radial.py -c config/hf_ang/configcuts_ptbin.yaml -f $INPUT_FILE -o $OUTPUT_DIR

# Move stdout to appropriate folder
mv /rstorage/alice/AnalysisResults/preeti/radial/slurm-${JOB_ID}_${TASK_ID}.out /rstorage/alice/AnalysisResults/preeti/radial/${JOB_ID}
