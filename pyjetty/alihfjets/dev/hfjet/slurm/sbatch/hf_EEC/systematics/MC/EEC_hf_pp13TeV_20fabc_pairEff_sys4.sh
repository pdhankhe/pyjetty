...
python process/user/hf_EEC/process_mc_hfjet_EEC_withpair.py -c config/hf_EEC/configcuts_ptbin_syst_TighterCutVariation_2_MC.yaml -f $INPUT_FILE -o $OUTPUT_DIR
