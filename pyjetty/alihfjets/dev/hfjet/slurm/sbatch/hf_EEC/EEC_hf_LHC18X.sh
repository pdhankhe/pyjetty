...
OUTPUT_SUFFIX=$(echo $INPUT_FILE | cut -d/ -f9-17)
#echo $OUTPUT_SUFFIX
...
python process/user/hf_EEC/process_data_hfjet_EEC.py -c config/hf_ang/configcuts_ptbin.yaml -f $INPUT_FILE -o $OUTPUT_DIR
