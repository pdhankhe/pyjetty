...
PTHAT_BINS=(20 50 100 150 200 500)
echo "Number of pT-hat bins: ${#PTHAT_BINS[@]}"

# Currently we have 8 nodes * 20 cores active
NCORES=168 # =28*6=28*(#pthatbins)
...
pipenv run python $SCRIPT -c $CONFIG --output-dir $OUTDIR \
    ...
    --pythiaopts HardQCD:all=on,TimeShower:pTmin=0.2 --nocharmdecay 1 --fulljets 1
