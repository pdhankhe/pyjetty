...
OUTPUT_PREFIX="AnalysisResults/preeti/jetaxes_sd/$JOB_ID"
...
python process/user/hf_jetaxes/process_mc_hfjet_jetaxes_sd.py -c config/hf_ang/configcuts_ptbin.yaml -f $INPUT_FILE -o $OUTPUT_DIR

# Move stdout to appropriate folder
mv /rstorage/alice/AnalysisResults/preeti/jetaxes_sd/slurm-${JOB_ID}_${TASK_ID}.out /rstorage/alice/AnalysisResults/preeti/jetaxes_sd/${JOB_ID}
