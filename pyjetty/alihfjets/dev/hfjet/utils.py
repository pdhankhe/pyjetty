...
global branch_names, gen_branch_names, cut_names, cut_type, cut_value, cut_value_var, cut_value_same, cut_value_13TeV_Note
branch_names = ['run_number', 'ev_id', 'inv_mass', 'pt_cand', 'pt_prong0', 'pt_prong1', 'dca', 'cos_t_star', 'imp_par_prod', 'cos_p', 'cand_type', 'imp_par_prong0', 'imp_par_prong1', 'norm_dl_xy', 'eta_cand']
gen_branch_names = ['run_number', 'ev_id', 'pt_cand', 'eta_cand', 'cand_type']
#cut_names = ['pt_prong0', 'pt_prong1', 'dca', 'cos_t_star', 'imp_par_prod', 'cos_p', 'imp_par_prong0', 'imp_par_prong1', 'norm_dl_xy', 'eta_cand']
cut_names = ['pt_prong0', 'pt_prong1', 'dca', 'cos_t_star', 'imp_par_prod', 'cos_p', 'eta_cand']
#cut_type = ['greater', 'greater', 'less', 'abs', 'less', 'greater', 'less', 'less', 'greater', 'abs']
#cut_type = ['greater', 'greater', 'less', 'abs', 'less', 'greater', 'abs', 'abs', 'greater', 'abs']
cut_type = ['greater', 'greater', 'less', 'abs', 'less', 'greater', 'abs']

cut_value = [[0.7, 0.7, 0.03, 0.8, -0.00008, 0.95, 0.1, 0.1, 4, 0.8],
[0.7, 0.7, 0.03, 0.8, -0.00008, 0.95, 0.1, 0.1, 4, 0.8],
[0.7, 0.7, 0.03, 0.9, -0.00005, 0.95, 0.1, 0.1, 3, 0.8],
[0.7, 0.7, 0.03, 0.9, -0.00005, 0.95, 0.1, 0.1, 3, 0.8],
[0.7, 0.7, 0.03, 1, 0.0001, 0.95, 0.1, 0.1, 3, 0.8],
[0.7, 0.7, 0.03, 1, 0.0001, 0.90, 0.1, 0.1, 3, 0.8],
[0.7, 0.7, 0.03, 1, 0.0001, 0.90, 0.1, 0.1, 3, 0.8]]

#[3.5, 4.5, 5.5, 6.5, 7.5, 9, 11, 14, 20, 30]
cut_value_13TeV_Note_FromWhere = [[0.7, 0.7, 0.03, 0.8, -0.0002, 0.9, 0.8],
						[0.7, 0.7, 0.03, 0.8, -0.0002, 0.9, 0.8],
						[0.7, 0.7, 0.03, 0.8, -0.00005, 0.85, 0.8],
						[0.7, 0.7, 0.03, 0.8, -0.00005, 0.85, 0.8],
						[0.7, 0.7, 0.03, 0.8, -0.00005, 0.85, 0.8],
						[0.7, 0.7, 0.03, 0.9, -0.00005, 0.85, 0.8],
						[0.7, 0.7, 0.03, 0.9, -0.00005, 0.85, 0.8],
						[0.6, 0.6, 0.03, 1, 100, 0.8, 0.8],
						[0.6, 0.6, 0.03, 1, 100, 0.8, 0.8],
						[0.6, 0.6, 0.03, 1, 100, 0.8, 0.8]]

cut_value_13TeV_Note = [[0.7, 0.7, 0.03, 0.8, -0.00012, 0.85, 0.8],
						[0.7, 0.7, 0.03, 0.8, -0.00008, 0.85, 0.8],
						[0.7, 0.7, 0.03, 0.8, -0.00008, 0.85, 0.8],
						[0.7, 0.7, 0.03, 0.8, -0.00008, 0.85, 0.8],
						[0.7, 0.7, 0.03, 0.8, -0.00007, 0.85, 0.8],
						[0.7, 0.7, 0.03, 0.8, 0.00005, 0.85, 0.8],
						[0.7, 0.7, 0.03, 0.8, 0.00005, 0.85, 0.8],
						[0.7, 0.7, 0.03, 0.8, 0.0001, 0.85, 0.8],
						[0.7, 0.7, 0.03, 0.8, 0.0001, 0.85, 0.8],
						[0.7, 0.7, 0.03, 0.8, 0.0001, 0.85, 0.8]]
...
cut_value_same = [[0.6, 0.6, 0.03, 0.8, -0.0001, 0.9, 0.8],
				  [0.6, 0.6, 0.03, 0.8, -0.0001, 0.9, 0.8],
				  [0.6, 0.6, 0.03, 0.8, -0.0001, 0.9, 0.8],
				  [0.6, 0.6, 0.03, 0.8, -0.0001, 0.9, 0.8],
				  [0.6, 0.6, 0.03, 0.8, -0.0001, 0.9, 0.8],
				  [0.6, 0.6, 0.03, 0.8, -0.0001, 0.9, 0.8],
