...
OUTPUT_PREFIX="AnalysisResults/preeti/ang/$JOB_ID"
...
cd /home/preeti/analysis/pyjetty/pyjetty/alihfjets/dev/hfjet/DmesonJet/testscripts/
python process_mc_hfjet.py -c configcuts_ptbin.yaml -f $INPUT_FILE -o $OUTPUT_DIR
