...
class RunAnalysisAng(run_analysis.RunAnalysis):
  ...
  def rawJetSpectra(self, sparse, jetR):
    ...
    for beta in self.beta_list:
        ...
        for ibin2 in range(len(self.fptbinsJetFinalA)-1):
            ...
            for ipt in range(self.fptbinsDN):
              ...
              hang_sig = h_shape_Dmesonpt_jetpt.Projection(1,3,"e")
              ...
              hang_sig_sb1 = h_shape_Dmesonpt_jetptleft.Projection(1,3,"e")
              ...
              hang_sig_sb2 = h_shape_Dmesonpt_jetptright.Projection(1,3,"e")
              ...
              #signal_sb_list[ipt].append(hang_bkg_scaled)
            ...
            hang_sb_sub_rebinned_list.append(self.histutils.rebin_th2(hrawjetptspectrum,"hang_sb_sub"+suffix_jet, jet_pt_bin_array, len(self.fptbinsJetFinalA)-1, obs_bin_array, len(self.fobs_bins)-1))
            hang_eff_corr_rebinned_list.append(self.histutils.rebin_th2(hang_corr,"hang_corr"+suffix_jet, jet_pt_bin_array, len(self.fptbinsJetFinalA)-1, obs_bin_array, len(self.fobs_bins)-1))
            
            cshapevsjetpt3 = ROOT.TCanvas()
            hangvsjetpt_sb_sub_projy1 = hang_sb_sub_rebinned_list[ibin2].ProjectionY()
            hangvsjetpt_sb_sub_projy1.Scale(1/hangvsjetpt_sb_sub_projy1.Integral(),"width")
            hangvsjetpt_sb_sub_projy1.GetYaxis().SetRangeUser(0,15)
            hangvsjetpt_sb_sub_projy1.GetYaxis().SetTitle("1/N_{jet} dN/d#lambda")
            hangvsjetpt_sb_sub_projy1.GetXaxis().SetTitle("#lambda")
            hangvsjetpt_sb_sub_projy1.Draw("ep")
            cshapevsjetpt3.SaveAs("hangvsjet_sb_sub_stats_{}_{}.pdf".format(self.fptbinsJetFinalA[ibin2],self.fptbinsJetFinalA[ibin2+1]))
            
            cshapevsjetpt3 = ROOT.TCanvas()
            hangvsjetpt_sb_sub_eff_projy1 = hang_eff_corr_rebinned_list[ibin2].ProjectionY()
            hangvsjetpt_sb_sub_eff_projy1.Scale(1/hangvsjetpt_sb_sub_eff_projy1.Integral(),"width")
            hangvsjetpt_sb_sub_projy1.GetYaxis().SetRangeUser(0,15)
            hangvsjetpt_sb_sub_eff_projy1.GetYaxis().SetTitle("1/N_{jet} dN/d#lambda")
            hangvsjetpt_sb_sub_eff_projy1.GetXaxis().SetTitle("#lambda")
            hangvsjetpt_sb_sub_eff_projy1.Draw("ep")
            #cshapevsjetpt3.SaveAs("hangvsjet_sb_sub_stats_eff_{}_{}.pdf".format(self.fptbinsJetFinalA[ibin2],self.fptbinsJetFinalA[ibin2+1]))
            
          
            #hangvsjetpt_sb_sub_content_to_error = hangvsjetpt_sb_sub_projy1.Clone("hangvsjetpt_sb_sub_content_to_error"+suffix_jet)
            #hang_corr_content_to_error = hangvsjetpt_sb_sub_eff_projy1.Clone("hangvsjetpt_sb_sub_content_to_error"+suffix_jet)
            #
            ...
            #cshapevsjetpt1.SaveAs("hangvsjet_sb_sub_stats_content_to_error_{}_{}.pdf".format(self.fptbinsJetFinalA[ibin2],self.fptbinsJetFinalA[ibin2+1]))
            #
            ...
            #cshapevsjetpt2.SaveAs("hangvsjet_sb_sub_stats_eff_content_to_error_{}_{}.pdf".format(self.fptbinsJetFinalA[ibin2],self.fptbinsJetFinalA[ibin2+1]))
            #cinvmass.SaveAs("invmass_{}_{}.pdf".format(self.fptbinsJetFinalA[ibin2],self.fptbinsJetFinalA[ibin2+1]))
    ...
    cshapevsjetpt3 = ROOT.TCanvas()
    hangvsjetpt_sb_sub.GetYaxis().SetRangeUser(0,0.6)
    hangvsjetpt_sb_sub.GetXaxis().SetRangeUser(5,20)
    hangvsjetpt_sb_sub.Draw("text")
    cshapevsjetpt3.SaveAs("hangvsjet_sb_sub_stats.pdf")
    
    cshapevsjetpt4 = ROOT.TCanvas()
    hangvsjetpt_eff_corr.GetYaxis().SetRangeUser(0,0.6)
    hangvsjetpt_eff_corr.GetXaxis().SetRangeUser(5,20)
