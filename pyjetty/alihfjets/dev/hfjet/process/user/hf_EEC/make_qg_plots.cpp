...
//    gROOT->SetBatch(); //prevents plots from showing up
    ...
    const char infile[] = "/rstorage/alice/AnalysisResults/blianggi/EEC/1296078/AnalysisResultsFinal.root";
...
//            t->Draw("same");
            ...
            std::string fname = outdir + "QG_comp_pt" + std::to_string(pt_min) + '-'
                + std::to_string(pt_max) + "_R" + jetR + "_nonorm.pdf"; //"_normbytype.pdf"; //"_nonorm.pdf";
