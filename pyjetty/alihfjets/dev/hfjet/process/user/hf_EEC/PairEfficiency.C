...
void PairEfficiency() {
	...
	TString path_to_inputfiles = "/rstorage/alice/AnalysisResults/blianggi/EEC/";
	TString inputfile = "1252842/AnalysisResultsFinal.root";
	TString outputfile = "./pair_efficiency.pdf";
...
//    path_to_inputfiles = "";
//    inputfile = test_inputfile; //hopefully this works lol
