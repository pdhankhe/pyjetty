	...
	def analysis(self, df):
		...
		for id0, d0 in enumerate(djmm.Ds):
			...
			if len(djets) > 0:
				...
				self.fsparseJetWTAvalue[4]=jet_wta.delta_R(dcand[0])
				self.fsparseJetWTAvalue[5]=j.delta_R(jet_wta)
