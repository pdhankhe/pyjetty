...
echo $OUTPUT_SUFFIX
OUTPUT_DIR="/rstorage/generators/pythia_alice/tree_fastsim/$JOB_ID/$OUTPUT_SUFFIX"
...
mv /rstorage/generators/pythia_alice/tree_fastsim/slurm-${JOB_ID}_${TASK_ID}.out /rstorage/generators/pythia_alice/tree_fastsim/${JOB_ID}/
