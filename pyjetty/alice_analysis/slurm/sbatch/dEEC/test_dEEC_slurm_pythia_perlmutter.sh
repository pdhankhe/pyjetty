...
#SBATCH --job-name="TESTpythia_dEECs"
...
FILE_PATHS='/global/cfs/projectdirs/alice/alicepro/hiccup/rstorage/generators/pythia_alice/tree_fastsim/1143757/files.txt'
