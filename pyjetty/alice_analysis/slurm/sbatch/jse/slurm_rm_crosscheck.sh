...
#SBATCH --job-name="RMs_crosscheck"
...
do
    ...
    OUTDIR="/global/cfs/projectdirs/alice/alicepro/hiccup/rstorage/alice/AnalysisResults/blianggi/jse/rm_crosscheck/$SLURM_ARRAY_JOB_ID/${OUTPUT_SUBDIR}"
    ...
    RM_CC_SCRIPT=/global/cfs/cdirs/alice/blianggi/mypyjetty/pyjetty/pyjetty/alice_analysis/process/user/jse/make_rms_crosschecks.py
    python $RM_CC_SCRIPT $PARQUET_FILE
    
done

# Move stdout to appropriate folder
cd /global/cfs/projectdirs/alice/alicepro/hiccup/rstorage/alice/AnalysisResults/blianggi/jse/rm_crosscheck/${SLURM_ARRAY_JOB_ID}/
mkdir -p slurm-output
mv /global/cfs/projectdirs/alice/alicepro/hiccup/rstorage/alice/AnalysisResults/blianggi/jse/slurm-${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.out /global/cfs/projectdirs/alice/alicepro/hiccup/rstorage/alice/AnalysisResults/blianggi/jse/rm_crosscheck/${SLURM_ARRAY_JOB_ID}/slurm-output/
