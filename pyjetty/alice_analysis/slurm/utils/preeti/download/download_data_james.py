...
def download_run(parent_dir, year, period, run, train_PWG, train_name, train_number, pt_hat_bins):
    ...
    if parent_dir == 'data':
        ...
        train_output_dir = '/alice/{}/{}/{}/000{}/{}/{}/{}'.format(parent_dir, year, period, run, train_PWG, train_name, train_number)
...
def download(train_output_dir, run, pt_hat_bin=None):
    ...
    if pt_hat_bin:
        run_path = '{}/000{}'.format(pt_hat_bin, run)
    else:
        run_path = run
    ...
    for subdir in subdirs:
        ...
        subdir_path = '000{}/{}'.format(run_path, subdir)
