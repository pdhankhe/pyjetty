...
void make_inclusive_sherpa_herwig_plots_write() {
...
//    gROOT->SetBatch(); //prevents plots from showing up
    ...
    //new files here:
    std::string infile_sherpa_inclusive_jetpt10 = "/rstorage/blianggi/sherpagen/inclusive_jetpt10/histograms/362440/361601/AnalysisResultsFinal.root";
    std::string infile_sherpa_inclusive_jetpt10_lund = "/rstorage/blianggi/sherpagen/inclusive_jetpt10_lund/histograms/362460/361713/AnalysisResultsFinal.root";
    std::string infile_sherpa_inclusive_jetpt15 = "/rstorage/blianggi/sherpagen/inclusive_jetpt15/histograms/362480/361721/AnalysisResultsFinal.root";
    std::string infile_sherpa_inclusive_jetpt15_lund = "/rstorage/blianggi/sherpagen/inclusive_jetpt15_lund/histograms/362500/361722/AnalysisResultsFinal.root";

    std::string infile_sherpa_inclusive_jetpt10_leadcut5 = "/rstorage/blianggi/sherpagen/inclusive_jetpt10/histograms/362943/361601/AnalysisResultsFinal.root";
    std::string infile_sherpa_inclusive_jetpt10_lund_leadcut5 = "/rstorage/blianggi/sherpagen/inclusive_jetpt10_lund/histograms/362963/361713/AnalysisResultsFinal.root";
    std::string infile_sherpa_inclusive_jetpt15_leadcut5 = "/rstorage/blianggi/sherpagen/inclusive_jetpt15/histograms/362983/361721/AnalysisResultsFinal.root";
    std::string infile_sherpa_inclusive_jetpt15_lund_leadcut5 = "/rstorage/blianggi/sherpagen/inclusive_jetpt15_lund/histograms/362923/361722/AnalysisResultsFinal.root";

    std::string infile_herwig_inclusive = "/rstorage/generators/herwig_alice/scaling/352629/329854/AnalysisResultsFinal.root";
    std::string infile_herwig_inclusive_leadcut5 = "/rstorage/generators/herwig_alice/scaling/363003/329854/AnalysisResultsFinal.root";

    // int plot_case:
    // 0 = just the 8 curves with leading pt cut (6 without pythia): herwig, sherpa ahadic, sherpa lund in 10-15 and 15-30
    // 1? = plot everything in a separate file, currently not set yet
    ...
    std::string outfile = outdir + "AnalysisResultsFinal_inclusive_2MC" + ".root"; 
    TFile* f_out = new TFile(outfile.c_str(), "RECREATE");

    int ifile = 0;
    std::string file_list[] = { infile_sherpa_inclusive_jetpt10_leadcut5, infile_sherpa_inclusive_jetpt10_lund_leadcut5, 
                                infile_sherpa_inclusive_jetpt15_leadcut5, infile_sherpa_inclusive_jetpt15_lund_leadcut5,
                                infile_herwig_inclusive_leadcut5 };
    std::string dname_list[] = { "i_sherpa_jetpt10_leadcut5", "i_sherpa_jetpt10_lund_leadcut5", 
                                 "i_sherpa_jetpt15_leadcut5", "i_sherpa_jetpt15_lund_leadcut5", 
                                 "i_herwig_leadcut5" };
        ...
        for (std::string jetR : jetR_list) {
            ...
            for (std::string trkthrd : trkthrd_list) {
                ...
                for (int i = 0; i < n_bins; i++) {
                    ...
                    if (ifile < 4 ) l->AddEntry("NULL","Sherpa"); //"PYTHIA 8 Monash 2013","h");
                    else l->AddEntry("Herwig 7","h");
                    ...
                    // don't write if sherpa jetpt10 and looking at 15-30 bin and v.v.
                    if (( ifile == 0 && pt_min == 10 ) ||
                        ( ifile == 1 && pt_min == 10 ) ||
                        ( ifile == 2 && pt_min == 15 ) ||
                        ( ifile == 3 && pt_min == 15 ) ||
                        ( ifile == 4 )) {
